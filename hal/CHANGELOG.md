...
## [0.23.2](https://github.com/QuantumEF/atsamd/compare/atsamd-hal-0.23.1...atsamd-hal-0.23.2) - 2026-02-08

### Added

- *(usb)* USB allocation rework and simplification ([#963](https://github.com/QuantumEF/atsamd/pull/963))

### Fixed

- *(pwm)* Fix for off-by-one in get_max_duty() ([#959](https://github.com/QuantumEF/atsamd/pull/959))
